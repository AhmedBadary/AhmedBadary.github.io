...
![definition](/main_files/128a/2.4/3.png){: width="85%"}
...
![definition](/main_files/128a/2.4/4.png){: width="85%"}
...
5. **Handling the problem of multiple roots:**{: style="color: SteelBlue  "}{: .bodyContents2 #bodyContents25} \\
    We define $$g(x)$$ as: \\
        ![definition](/main_files/128a/2.4/12.png){:height="80px"} 

    [Derivation can be found here!](/main_files/128a/2.4/derivation.png)
