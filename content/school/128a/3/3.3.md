...
1. **What?:**{: style="color: SteelBlue  "}{: .bodyContents1 #bodyContents11} \\
    A recursive method definition used to successively generate the approximating polynomials.
2. **Form of the Polynomial:**{: style="color: SteelBlue  "}{: .bodyContents1 #bodyContents12} \\
    ...
    * **Evaluated at $$x_0$$:** $$\ P_n(x_0) = a0 = f(x_0).$$
...
2. **Why?:**{: style="color: SteelBlue  "}{: .bodyContents4 #bodyContents42} \\
    The Newton forward- and backward-difference formulas are not appropriate for approximating
    $$f(x)$$ when x lies near the center of the table because neither will permit the highest-order
    difference to have $$x_0$$ close to x.
