...
1. **Loss Functions:**{: style="color: SteelBlue"}{: .bodyContents1 #bodyContents11}    
...
3. **:**{: style="color: SteelBlue"}{: .bodyContents1 #bodyContents13}    


4. **Loss Functions for Classification:**{: style="color: SteelBlue"}{: .bodyContents1 #bodyContents14}    

5. **Loss Functions for Regression:**{: style="color: SteelBlue"}{: .bodyContents1 #bodyContents15}    
...
11. **Introduction:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents211}    
...
1. **MSE:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents21}    
...
2. **MAE:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents22}    
...
3. **Huber Loss:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents23}    
...
5. **KL-Divergence:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents25}  

    
    <p>$$L(\hat{y}, y) = $$</p>  


6. **Analysis and Discussion:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents26}  
...
7. **Notes:**{: style="color: SteelBlue"}{: .bodyContents2 #bodyContents27}  
...
![img](/main_files/dl/concepts/loss_funcs/0.png){: width="65%"}  

11. **$$0-1$$ Loss:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents311}    
    
    <p>$$L(\hat{y}, y) = I(\hat{y} \neq y) = \left\{\begin{array}{ll}{0} & {\hat{y}=y} \\ {1} & {\hat{y} \neq y}\end{array}\right.$$</p>  

1. **MSE:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents31}    
...
2. **Hinge Loss:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents32}    
...
3. **Logistic Loss:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents33}  
...
4. **Cross-Entropy (Log Loss):**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents34}  
...
5. **Exponential Loss:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents35}  

    <p>$$L(\hat{y}, y) = e^{-\beta y \hat{y}}$$</p>  

6. **Perceptron Loss:**{: style="color: SteelBlue"}{: .bodyContents3 #bodyContents36}  
