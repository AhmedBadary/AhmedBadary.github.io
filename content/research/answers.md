...
* __What is the learning rate?__{: style="color: red"}  
    ...
    * __What is its range?__{: style="color: blue"}  
        $$[0.0001, 0.4]$$  
    * __How do we choose the learning rate?__{: style="color: blue"}  
        ...
        2. Do  
            ...
            * __Non-Smooth Functions (non-NN)__:  
                * __Direct Line Search__  
            ...
            * __Population-Based Training (PBT)__: is an elegant implementation of using a genetic algorithm for hyper-parameter choice.  
            * __Bayesian Optimization__: is a global optimization method for noisy black-box functions.  
    ...
    * __Learning Rate Schedule:__{: style="color: blue"}  
        ...
        * __List Types:__{: style="color: blue"}  
...
* __List the variants of GD:__{: style="color: red"}  
    ...
    2. __Stochastic GD__  
    3. __Mini-Batch GD__  
    * __How do they differ? Why?:__{: style="color: blue"}  
...
* __Adagrad__{: style="color: red"}  
    ...
    * __Properties:__{: style="color: blue"}  
        ...
        * __Weakness $$\rightarrow$$ Accumulation of the squared gradients in the denominator__:  
        ...
        * __Without the sqrt, the algorithm performs *much worse*__  
...
* __Describe the Intuition for Information Theory. Intuitively, how does the theory quantify information (list)?__{: style="color: red"}  
...
* __When does K-Means fail to give good results?__{: style="color: red"}  
...
* __What is a CNN?__{: style="color: red"}  
    ...
    * __What kind of data does it work on? What is the mathematical property?__{: style="color: blue"}  
...
* __List the different activation functions used in ML?__{: style="color: red"}  
    ...
    * __Sigmoid__:  
        ...
        * __Properties__:  
            ...
            * __Cons__:  
                * They Saturate and kill gradients $$\rightarrow$$ Gives rise to __vanishing gradients__ $$\rightarrow$$ Stop Learning  
...
* __Describe ways to overcome scaling (scalability) issues:__{: style="color: red"}  
